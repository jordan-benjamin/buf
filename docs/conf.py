...
# -*- coding: utf-8 -*-
#
# buf docs build configuration file, created by
...
project = 'buf'
copyright = '2018, Jordan Juravsky'
...
latex_documents = [
    (master_doc, 'buf.tex', 'buf Documentation',
     'Jordan Juravsky', 'manual'),
]
...
man_pages = [
    (master_doc, 'buf', 'buf Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'buf', 'buf 1.0.0 Documentation',
     author, 'buf', 'Command line toolkit for making buffers and solutions',
     'Science'),
]
